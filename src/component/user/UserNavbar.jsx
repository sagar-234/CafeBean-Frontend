   ...
   return(
    ...
    <nav className="navbar navbar-expand-sm" style={{ textAlign: 'right'}}>
      ...
      <MdFastfood size={'18pt'} style={{marginRight:'10px'}}/>
       ...
       <span style={{fontSize:'2rem'}}>CafeBean</span> </div>
        ...
        <li className="nav-item">
          ...
          <li className="nav-item dropdown">
            <Link className="nav-link dropdown-toggle" style={{height:'100%',display:'flex',alignItems:"center"}} id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             <BsFillPersonFill/><span style={{marginLeft:'5px'}}>{JSON.parse(sessionStorage.getItem('log')).username}</span>
            </Link>
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/user/recentVisits" style={{height:'100%',display:'flex',alignItems:"center"}}><AiFillShopping/><span style={{marginLeft:"5px"}}>Recent Visits</span></Link>
          </li>
